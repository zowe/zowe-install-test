...
export CIZT_ZOSMF_SAFKEYRING=izusvr/IZUKeyring.IZUDFLT
export CIZT_ZOSMF_SYSTEM=S0W1
# Zowe ports
...
export CIZT_SMPE_TARGET_ZONE=TZONE

# Portable Software Instance
export CIZT_PSI_NAME=ZOWE_SI
export CIZT_PSI_DSN=ZOWEAD3.EXPORT
export CIZT_PSI_VOLSER=ZOWE02 # TODO put here some other existing volume
