...
cat "${INSTANCE_ENV}" | \
  ...
  sed -e "s%ZOWE_INSTANCE=.*\$%ZOWE_INSTANCE=${CIZT_ZOWE_KEYSTORE_DIR}%" | \
  sed -e "s%ZOWE_SERVER_PROCLIB_MEMBER=.*\$%ZOWE_SERVER_PROCLIB_MEMBER=${CIZT_ZOWE_KEYSTORE_DIR}%" | \
  ...
  sed -e "s%APIML_ENABLE_SSO=.*\$%APIML_ENABLE_SSO=${CIZT_ZOWE_KEYSTORE_DIR}%" | \
  ...
  sed -e "s%ZOWE_ZSS_SERVER_PORT=.*\$%ZOWE_ZSS_SERVER_PORT=${CIZT_ZOWE_KEYSTORE_DIR}%" | \
