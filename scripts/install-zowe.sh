...
DEFAULT_CI_PROCLIB_DS_NAME=VENDOR.PROCLIB
...
CI_ZSS_PROCLIB_DS_NAME=VENDOR.PROCLIB
CI_ZSS_PARMLIB_DS_NAME=VENDOR.PARMLIB
CI_ZSS_LOADLIB_DS_NAME=VENDOR.LINKLIB
