...
################################################################################
# constants
export CIZT_TARGET_SERVER=marist-2
...
export CIZT_TEST_IMAGE_GUEST_SSH_HOSTPORT=ssh-marist-server-zzow02-hostport
# The SSH credential used to connect to test z/OS server
export CIZT_TEST_IMAGE_GUEST_SSH_CREDENTIAL=ssh-marist-server-zzow02
