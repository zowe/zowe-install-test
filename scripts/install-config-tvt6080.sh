...
################################################################################
# constants
export CIZT_TARGET_SERVER=tvt6080
export CIZT_TMP=/tmp
# directories
export CIZT_ZOWE_ROOT_DIR=/opt/zowe
export CIZT_ZOWE_USER_DIR=/opt/zowe/zowe-instance-dir
export CIZT_INSTALL_DIR=/opt/jenkins/dl/zowe-oss
export CIZT_ZOWE_KEYSTORE_DIR=/opt/zowe/keystore
# proclib / job name
export CIZT_PROCLIB_DS=auto
export CIZT_PROCLIB_MEMBER=ZWESVSTC
export CIZT_ZOWE_JOB_PREFIX=ZWE
# z/OSMF port
export CIZT_ZOSMF_PORT=443
# Zowe ports
...
export CIZT_TEST_IMAGE_GUEST_SSH_HOSTPORT=zowe-oss-server-hostport-tvt6080
# The SSH credential used to connect to test z/OS server
export CIZT_TEST_IMAGE_GUEST_SSH_CREDENTIAL=zowe-oss-server-ssh-tvt6080
# zD&T host name should be converted
export CIZT_ZDNT_HOSTNAME=

# SMP/e installation parameters
export CIZT_SMPE_HLQ_DSN=IBMUSER
export CIZT_SMPE_HLQ_CSI=IBMUSER.SMPE
export CIZT_SMPE_HLQ_TZONE=IBMUSER.SMPE
export CIZT_SMPE_HLQ_DZONE=IBMUSER.SMPE
export CIZT_SMPE_REL_FILE_PREFIX=IBMUSER
export CIZT_SMPE_PATH_PREFIX=/opt/
export CIZT_SMPE_PATH_DEFAULT=usr/lpp/zowe
export CIZT_SMPE_VOLSER=
