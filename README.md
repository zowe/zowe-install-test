...
ZOWE_ROOT_DIR=/path/to/zowe \
  ...
  ZOWE_EXPLORER_UI_JES_PORT=8546 \
  ZOWE_EXPLORER_UI_MVS_PORT=8548 \
  ZOWE_EXPLORER_UI_USS_PORT=8550 \
  npm test
```
...
```
cross-env ZOWE_ROOT_DIR=/path/to/zowe SSH_HOST=test-server SSH_PORT=12022 SSH_USER=********* SSH_PASSWD=********* ZOSMF_PORT=10443 ZOWE_ZLUX_HTTPS_PORT=8544 ZOWE_EXPLORER_JOBS_PORT=8545 ZOWE_EXPLORER_DATASETS_PORT=8547 ZOWE_EXPLORER_UI_JES_PORT=8546 ZOWE_EXPLORER_UI_MVS_PORT=8548 ZOWE_EXPLORER_UI_USS_PORT=8550 npm test
```
