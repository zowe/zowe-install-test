...
describe('test uss explorer', function() {
  ...
  it('should be able to list Zowe installation folder', async function() {
    ...
    // save screenshot
    await saveScreenshotWithAppContext(this, driver, testName, 'file-list-loaded', APP_TO_TEST, MVD_IFRAME_APP_CONTEXT);
  ...
  it(`should be able to load content of ${DIR_TO_TEST}/${FILE_TO_TEST} file`, async function() {
    ...
    // save screenshot
    await saveScreenshotWithAppContext(this, driver, testName, 'file-content-loaded', APP_TO_TEST, MVD_IFRAME_APP_CONTEXT);
  });
