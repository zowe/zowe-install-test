...
describe(`test ${APP_TO_TEST}`, function() {
  ...
  it('should be able to list Zowe installation folder', async function() {
    ...
    // save screenshot
    await saveScreenshotWithAppContext(this, driver, testName, 'file-list-loaded', APP_TO_TEST, MVD_ATLAS_APP_CONTEXT);
  ...
  it(`should be able to load content of ${DIR_TO_TEST}/${FILE_TO_TEST} file`, async function() {
    ...
    // save screenshot
    await saveScreenshotWithAppContext(this, driver, testName, 'file-content-loaded', APP_TO_TEST, MVD_ATLAS_APP_CONTEXT);
  });
